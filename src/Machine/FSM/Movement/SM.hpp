...
//                 state<Turning<>::WaitForUser::Waiting> ,state<Turning<>> + event<ExitEvent> /
//                 Action() = state<Idle> ,state<Turning<>> + event<Turning<>::SetSettingsEvent> /
//                 Action() = state<Turning<>::WaitForUser::Waiting>

//                 //child states
//                 //WaitForuser
//                 ,state<Turning<>::WaitForUser::Waiting> +
//                 event<Turning<>::WaitForUser::Waiting::ReturnToStartEvent> / Action() =
//                 state<Turning<>::ReturnToStart> ,state<Turning<>::WaitForUser::Waiting> +
...
//                 event<MoveDoneEvent> / Action() =
//                 state<Turning<>::TurningPass::Moving::Retracting>
//                 ,state<Turning<>::TurningPass::Moving::Retracting> + event<MoveDoneEvent> /
//                 Action() = state<Turning<>::WaitForUser::Waiting>
