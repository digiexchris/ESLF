...
class IdleState : public etl::fsm_state<MachineFSM, IdleState, MachineStateId::IDLE, MessageBus::StartMessage, MessageBus::StartAtMessage, MessageBus::EStopMessage, MessageBus::ResetMessage>
{
public:
  ...
  etl::fsm_state_id_t on_event(const MessageBus::StartAtMessage& msg);
