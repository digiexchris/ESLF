...
class TurningState : public etl::fsm_state<MachineFSM, TurningState, MachineStateId::TURNING, MessageBus::StopMessage, MessageBus::EStopMessage, MessageBus::ResetMessage>
{
public:
